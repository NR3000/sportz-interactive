...
const PlayerCard = (props) => {
  ...
  // console.log(zone.toLocaleTimeString())
  return (
    <div className='player-card'>
      ...
      <p><span>Upcoming Match: </span>{props.playerData.UpComingMatchesList[0].CCode === "" ? "-" : props.playerData.UpComingMatchesList[0].CCode+" vs "+props.playerData.UpComingMatchesList[0].VsCCode}</p>
      <p>
        <span>Date: </span>
        { 
